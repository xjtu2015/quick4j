    ...
    <body class="page-header-fixed">
            ...
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                        ...
                        <li class=" ">
                            <a href="javascript:;">
                                <i class="glyphicon glyphicon-send"></i><span class="title">知识建模</span><span
                                class="arrow"> </span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="rest/page/conceptmodel">概念域建模</a>

                                </li>
                                <li>
                                    <a href="javascript:;">功能域建模</a>
                                </li>
                                <li>
                                    <a href="javascript:;">问题域建模</a>
                                </li>
                                <li>
                                    <a href="javascript:;">生成元数据</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="">
                            <a href="javascript:;" >
                                <i class="glyphicon glyphicon-wrench"></i><span class="title">故障诊断</span><span
                                    class="selected"> </span>
                            </a>
                        </li>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="page-breadcrumb breadcrumb" id="page-title-men">
                                <li>

                                    <a href="rest/page/dashboard">
                                        <i class="fa fa-home"></i>  首页&nbsp&nbsp&nbsp
                                    </a>

                                </li>

                                <li id="page-title-pare">


                                </li>
                                <i class="fa fa-angle-right"></i>
                                <li id="page-title-chil">
                    ...
                    <iframe id="iframe" src="rest/page/dashboard"
        ...
        <div class="footer">
            <div class="footer-inner">
                2016 &copy; xjtu.software academy.
            </div>
